...
function registerMoviesType()
{
    $labels = [
        'name'                  => _x('movies', 'Post Type General Name', 'flynt'),
        'singular_name'         => _x('Movie', 'Post Type Singular Name', 'flynt'),
        'menu_name'             => __('Movies', 'flynt'),
        'name_admin_bar'        => __('Movies', 'flynt'),
    ...
    $args = [
        'label'                 => __('Movies', 'flynt'),
        'description'           => __('Movie Description', 'flynt'),
        'labels'                => $labels,
...
add_action('init', '\\Flynt\\CustomPostTypes\\registerMoviesType');
