...
namespace Flynt\Components\BlockNowShowing;
...
add_filter('Flynt/addComponentData?name=BlockNowShowing', function ($data) {
...
{
    return [
        'name' => 'BlockNowShowing',
        'label' => 'Block: Now Showing',
        'sub_fields' => [
            [
