...
namespace Flynt\Components\BlockMovieHeader;

use Flynt\Utils\Options;

add_filter('Flynt/addComponentData?name=BlockMovieHeader', function ($data) {

    return $data;
});

Options::addTranslatable('BlockMovieHeader', [
    [
