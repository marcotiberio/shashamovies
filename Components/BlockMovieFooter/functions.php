...
namespace Flynt\Components\BlockMovieFooter;

use Flynt\Utils\Options;

add_filter('Flynt/addComponentData?name=BlockMovieFooter', function ($data) {

    return $data;
});

Options::addTranslatable('BlockMovieFooter', [
    [
