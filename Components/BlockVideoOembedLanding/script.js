...
class BlockVideoOembedLanding extends window.HTMLDivElement {
  constructor (...args) {
...
window.customElements.define('flynt-block-video-oembed-landing', BlockVideoOembedLanding, { extends: 'div' })
