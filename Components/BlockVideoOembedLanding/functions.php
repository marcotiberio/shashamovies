...
namespace Flynt\Components\BlockVideoOembedLanding;

use Flynt\FieldVariables;
use Flynt\Utils\Oembed;

add_filter('Flynt/addComponentData?name=BlockVideoOembedLanding', function ($data) {
